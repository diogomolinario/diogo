...
1. Instalar o FortiClient para acesso ao VPN. 
    * Download do PDF de configuração da VPN [![](imgs/download.png#only-light){ align=center width="30"} ![](imgs/download.png#only-dark){ align=center width="30"}](pdf/vpn.pdf "download")
